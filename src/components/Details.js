  ...
  const userlogout = ()=>{
    ...
    return (
        <>
          ...
          <div className="image"><img src={logo} alt="Logo" style={{ marginLeft:'430px',width: '700px', height: '250px' }}/></div>
          
          {editForm===false&&(
            <div className="form">
              <form autoComplete="off" onSubmit={handleSubmit}>
                <div className="input-and-button">
                  <input className="input-box" type='text' placeholder="Add an Item" required
